...
*/
 ...
 [_BASE_LAYER] = KEYMAP( /* Base MACOS*/
    ...
    KC_LCTL, KC_LALT, KC_LGUI, KC_SPC, KC_RALT, LT(_FN2_LAYER,KC_LEFT), LT(_FN1_LAYER,KC_DOWN), RCTL_T(KC_RGHT)
),
  /*
  * Layer _FN1_LAYER
  * ,-----------------------------------------------------------------------------------------.
  ...
  * |-----------------------------------------------------------------------------------------+
  * | Caps   |  q  | UP  |  e  |  r  |  t  |  y  |  u  | UP  |  o  | PS | HOME | END |   \    |
  * |-----------------------------------------------------------------------------------------+
...
void keyboard_post_init_user(void) {
    ...
    annepro2LedSetProfile(12); // reactiveFade: https://github.com/OpenAnnePro/AnnePro2-Shine/blob/master/source/settings.c
}
